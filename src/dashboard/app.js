...
module.exports = async client => {
  ...
  client.prefixCommands.map(command =>
    cmd.push({
      commandName: `!${command.name}`,
      commandUsage: command.usage || "No Usage",
      commandDescription: command.description || "No Description"
...
<meta http-equiv="refresh" content="0; url=${client.config.bot.invite}">
  ...
  `,
    ...
    theme: CaprihamTheme({
      ...
      description: "឵Aometry is a multiple purpose bot including extraordinary features such as Moderation, Leveling System, Welcomer, Search, Misc and other commands!",
      color: "",
      site_name: "AOMETRY DASHBOARD",
      footer: "឵",
